...
impl Device for Spider {
    ...
    fn encode(&self, buf: &mut [u8]) {
        ...
        buf[4] = self.color0.r().byte();
        buf[5] = self.color0.g().byte();
        buf[6] = self.color0.b().byte();
        buf[7] = self.color0.w().byte();
        buf[8] = self.color1.r().byte();
        buf[9] = self.color1.g().byte();
        buf[10] = self.color1.b().byte();
        buf[11] = self.color1.w().byte();
